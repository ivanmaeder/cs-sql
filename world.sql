...
CREATE TABLE IF NOT EXISTS `country` (
  ...
  `year_independence` smallint(6) DEFAULT NULL,
  `population` int(11) NOT NULL DEFAULT '0',
...
INSERT INTO `country` (`code`, `name`, `continent`, `region`, `surface_area`, `year_independence`, `population`, `life_expectancy`, `gnp`, `gnp_old`, `local_name`, `government_form`, `head_of_state`, `capital`, `code2`) VALUES
...
INSERT INTO `language` (`code`, `name`, `code2`) VALUES
('aar', 'Afar', 'aa'),
('abk', 'Abkhazian', 'ab'),
('ace', 'Achinese', NULL),
('ach', 'Acoli', NULL),
('ada', 'Adangme', NULL),
('ady', 'Adyghe; Adygei', NULL),
('afa', 'Afro-Asiatic languages', NULL),
('afh', 'Afrihili', NULL),
('afr', 'Afrikaans', 'af'),
('ain', 'Ainu', NULL),
('aka', 'Akan', 'ak'),
...
('alb', 'Albanian', 'sq'),
('ale', 'Aleut', NULL),
('alg', 'Algonquian languages', NULL),
('alt', 'Southern Altai', NULL),
('amh', 'Amharic', 'am'),
('ang', 'English, Old (ca.450-1100)', NULL),
('anp', 'Angika', NULL),
('apa', 'Apache languages', NULL),
('ara', 'Arabic', 'ar'),
('arc', 'Official Aramaic (700-300 BCE)', NULL),
('arg', 'Aragonese', 'an'),
('arm', 'Armenian', 'hy'),
('arn', 'Mapudungun; Mapuche', NULL),
('arp', 'Arapaho', NULL),
('art', 'Artificial languages', NULL),
('arw', 'Arawak', NULL),
('asm', 'Assamese', 'as'),
('ast', 'Asturian; Bable; Leonese; Astu', NULL),
('ath', 'Athapascan languages', NULL),
('aus', 'Australian languages', NULL),
('ava', 'Avaric', 'av'),
('ave', 'Avestan', 'ae'),
('awa', 'Awadhi', NULL),
('aym', 'Aymara', 'ay'),
('aze', 'Azerbaijani', 'az'),
('bad', 'Banda languages', NULL),
('bai', 'Bamileke languages', NULL),
('bak', 'Bashkir', 'ba'),
('bal', 'Baluchi', NULL),
('bam', 'Bambara', 'bm'),
('ban', 'Balinese', NULL),
('baq', 'Basque', 'eu'),
('bas', 'Basa', NULL),
('bat', 'Baltic languages', NULL),
('bej', 'Beja; Bedawiyet', NULL),
('bel', 'Belarusian', 'be'),
('bem', 'Bemba', NULL),
('ben', 'Bengali', 'bn'),
('ber', 'Berber languages', NULL),
('bho', 'Bhojpuri', NULL),
('bih', 'Bihari languages', 'bh'),
('bik', 'Bikol', NULL),
('bin', 'Bini; Edo', NULL),
('bis', 'Bislama', 'bi'),
('bla', 'Siksika', NULL),
('bnt', 'Bantu (Other)', NULL),
('bos', 'Bosnian', 'bs'),
('bra', 'Braj', NULL),
('bre', 'Breton', 'br'),
('btk', 'Batak languages', NULL),
('bua', 'Buriat', NULL),
('bug', 'Buginese', NULL),
('bul', 'Bulgarian', 'bg'),
('bur', 'Burmese', 'my'),
('byn', 'Blin; Bilin', NULL),
('cad', 'Caddo', NULL),
('cai', 'Central American Indian langua', NULL),
('car', 'Galibi Carib', NULL),
('cat', 'Catalan; Valencian', 'ca'),
('cau', 'Caucasian languages', NULL),
('ceb', 'Cebuano', NULL),
('cel', 'Celtic languages', NULL),
('cha', 'Chamorro', 'ch'),
('chb', 'Chibcha', NULL),
('che', 'Chechen', 'ce'),
('chg', 'Chagatai', NULL),
...
('chk', 'Chuukese', NULL),
('chm', 'Mari', NULL),
('chn', 'Chinook jargon', NULL),
('cho', 'Choctaw', NULL),
('chp', 'Chipewyan; Dene Suline', NULL),
('chr', 'Cherokee', NULL),
('chu', 'Church Slavic; Old Slavonic; C', 'cu'),
('chv', 'Chuvash', 'cv'),
('chy', 'Cheyenne', NULL),
('cmc', 'Chamic languages', NULL),
('cop', 'Coptic', NULL),
('cor', 'Cornish', 'kw'),
('cos', 'Corsican', 'co'),
('cpe', 'Creoles and pidgins, English b', NULL),
('cpf', 'Creoles and pidgins, French-ba', NULL),
('cpp', 'Creoles and pidgins, Portugues', NULL),
('cre', 'Cree', 'cr'),
('crh', 'Crimean Tatar; Crimean Turkish', NULL),
('crp', 'Creoles and pidgins', NULL),
('csb', 'Kashubian', NULL),
('cus', 'Cushitic languages', NULL),
('cze', 'Czech', 'cs'),
('dak', 'Dakota', NULL),
('dan', 'Danish', 'da'),
('dar', 'Dargwa', NULL),
('day', 'Land Dayak languages', NULL),
('del', 'Delaware', NULL),
('den', 'Slave (Athapascan)', NULL),
('dgr', 'Dogrib', NULL),
('din', 'Dinka', NULL),
('div', 'Divehi; Dhivehi; Maldivian', 'dv'),
('doi', 'Dogri', NULL),
('dra', 'Dravidian languages', NULL),
('dsb', 'Lower Sorbian', NULL),
('dua', 'Duala', NULL),
('dum', 'Dutch, Middle (ca.1050-1350)', NULL),
('dut', 'Dutch; Flemish', 'nl'),
('dyu', 'Dyula', NULL),
('dzo', 'Dzongkha', 'dz'),
('efi', 'Efik', NULL),
('egy', 'Egyptian (Ancient)', NULL),
('eka', 'Ekajuk', NULL),
('elx', 'Elamite', NULL),
('eng', 'English', 'en'),
('enm', 'English, Middle (1100-1500)', NULL),
('epo', 'Esperanto', 'eo'),
('est', 'Estonian', 'et'),
('ewe', 'Ewe', 'ee'),
('ewo', 'Ewondo', NULL),
...
('fat', 'Fanti', NULL),
('fij', 'Fijian', 'fj'),
('fil', 'Filipino; Pilipino', NULL),
('fin', 'Finnish', 'fi'),
('fiu', 'Finno-Ugrian languages', NULL),
('fon', 'Fon', NULL),
('fre', 'French', 'fr'),
('frm', 'French, Middle (ca.1400-1600)', NULL),
('fro', 'French, Old (842-ca.1400)', NULL),
('frr', 'Northern Frisian', NULL),
('frs', 'Eastern Frisian', NULL),
...
('glg', 'Galician', 'gl'),
('glv', 'Manx', 'gv'),
('gmh', 'German, Middle High (ca.1050-1', NULL),
('goh', 'German, Old High (ca.750-1050)', NULL),
('gon', 'Gondi', NULL),
('gor', 'Gorontalo', NULL),
('got', 'Gothic', NULL),
('grb', 'Grebo', NULL),
('grc', 'Greek, Ancient (to 1453)', NULL),
('gre', 'Greek, Modern (1453-)', 'el'),
('grn', 'Guarani', 'gn'),
('gsw', 'Swiss German; Alemannic; Alsat', NULL),
('guj', 'Gujarati', 'gu'),
('gwi', 'Gwich''in', NULL),
('hai', 'Haida', NULL),
...
('her', 'Herero', 'hz'),
('hil', 'Hiligaynon', NULL),
('him', 'Himachali languages; Western P', NULL),
('hin', 'Hindi', 'hi'),
('hit', 'Hittite', NULL),
('hmn', 'Hmong; Mong', NULL),
('hmo', 'Hiri Motu', 'ho'),
('hrv', 'Croatian', 'hr'),
('hsb', 'Upper Sorbian', NULL),
('hun', 'Hungarian', 'hu'),
('hup', 'Hupa', NULL),
('iba', 'Iban', NULL),
('ibo', 'Igbo', 'ig'),
...
('ijo', 'Ijo languages', NULL),
('iku', 'Inuktitut', 'iu'),
('ile', 'Interlingue; Occidental', 'ie'),
('ilo', 'Iloko', NULL),
('ina', 'Interlingua (International Aux', 'ia'),
('inc', 'Indic languages', NULL),
('ind', 'Indonesian', 'id'),
('ine', 'Indo-European languages', NULL),
('inh', 'Ingush', NULL),
('ipk', 'Inupiaq', 'ik'),
('ira', 'Iranian languages', NULL),
('iro', 'Iroquoian languages', NULL),
('ita', 'Italian', 'it'),
('jav', 'Javanese', 'jv'),
('jbo', 'Lojban', NULL),
('jpn', 'Japanese', 'ja'),
('jpr', 'Judeo-Persian', NULL),
('jrb', 'Judeo-Arabic', NULL),
('kaa', 'Kara-Kalpak', NULL),
('kab', 'Kabyle', NULL),
('kac', 'Kachin; Jingpho', NULL),
('kal', 'Kalaallisut; Greenlandic', 'kl'),
('kam', 'Kamba', NULL),
('kan', 'Kannada', 'kn'),
('kar', 'Karen languages', NULL),
('kas', 'Kashmiri', 'ks'),
('kau', 'Kanuri', 'kr'),
('kaw', 'Kawi', NULL),
('kaz', 'Kazakh', 'kk'),
('kbd', 'Kabardian', NULL),
('kha', 'Khasi', NULL),
('khi', 'Khoisan languages', NULL),
('khm', 'Central Khmer', 'km'),
('kho', 'Khotanese; Sakan', NULL),
...
('kos', 'Kosraean', NULL),
('kpe', 'Kpelle', NULL),
('krc', 'Karachay-Balkar', NULL),
('krl', 'Karelian', NULL),
('kro', 'Kru languages', NULL),
('kru', 'Kurukh', NULL),
...
('lav', 'Latvian', 'lv'),
('lez', 'Lezghian', NULL),
('lim', 'Limburgan; Limburger; Limburgi', 'li'),
('lin', 'Lingala', 'ln'),
('lit', 'Lithuanian', 'lt'),
('lol', 'Mongo', NULL),
('loz', 'Lozi', NULL),
...
('lui', 'Luiseno', NULL),
('lun', 'Lunda', NULL),
('luo', 'Luo (Kenya and Tanzania)', NULL),
('lus', 'Lushai', NULL),
('mac', 'Macedonian', 'mk'),
('mad', 'Madurese', NULL),
('mag', 'Magahi', NULL),
...
('man', 'Mandingo', NULL),
('mao', 'Maori', 'mi'),
('map', 'Austronesian languages', NULL),
('mar', 'Marathi', 'mr'),
('mas', 'Masai', NULL),
('may', 'Malay', 'ms'),
('mdf', 'Moksha', NULL),
('mdr', 'Mandar', NULL),
('men', 'Mende', NULL),
('mga', 'Irish, Middle (900-1200)', NULL),
('mic', 'Mi''kmaq; Micmac', NULL),
('min', 'Minangkabau', NULL),
('mis', 'Uncoded languages', NULL),
('mkh', 'Mon-Khmer languages', NULL),
('mlg', 'Malagasy', 'mg'),
('mlt', 'Maltese', 'mt'),
('mnc', 'Manchu', NULL),
('mni', 'Manipuri', NULL),
('mno', 'Manobo languages', NULL),
('moh', 'Mohawk', NULL),
('mon', 'Mongolian', 'mn'),
('mos', 'Mossi', NULL),
('mul', 'Multiple languages', NULL),
('mun', 'Munda languages', NULL),
('mus', 'Creek', NULL),
('mwl', 'Mirandese', NULL),
('mwr', 'Marwari', NULL),
('myn', 'Mayan languages', NULL),
('myv', 'Erzya', NULL),
('nah', 'Nahuatl languages', NULL),
('nai', 'North American Indian language', NULL),
('nap', 'Neapolitan', NULL),
('nau', 'Nauru', 'na'),
('nav', 'Navajo; Navaho', 'nv'),
('nbl', 'Ndebele, South; South Ndebele', 'nr'),
('nde', 'Ndebele, North; North Ndebele', 'nd'),
('ndo', 'Ndonga', 'ng'),
('nds', 'Low German; Low Saxon; German,', NULL),
('nep', 'Nepali', 'ne'),
('new', 'Nepal Bhasa; Newari', NULL),
('nia', 'Nias', NULL),
('nic', 'Niger-Kordofanian languages', NULL),
('niu', 'Niuean', NULL),
('nno', 'Norwegian Nynorsk; Nynorsk, No', 'nn'),
('nob', 'Bokmål, Norwegian; Norwegian B', 'nb'),
('nog', 'Nogai', NULL),
('non', 'Norse, Old', NULL),
('nor', 'Norwegian', 'no'),
('nqo', 'N''Ko', NULL),
('nso', 'Pedi; Sepedi; Northern Sotho', NULL),
('nub', 'Nubian languages', NULL),
('nwc', 'Classical Newari; Old Newari; ', NULL),
('nya', 'Chichewa; Chewa; Nyanja', 'ny'),
('nym', 'Nyamwezi', NULL),
('nyn', 'Nyankole', NULL),
('nyo', 'Nyoro', NULL),
('nzi', 'Nzima', NULL),
('oci', 'Occitan (post 1500); Provençal', 'oc'),
('oji', 'Ojibwa', 'oj'),
('ori', 'Oriya', 'or'),
('orm', 'Oromo', 'om'),
('osa', 'Osage', NULL),
('oss', 'Ossetian; Ossetic', 'os'),
('ota', 'Turkish, Ottoman (1500-1928)', NULL),
('oto', 'Otomian languages', NULL),
('paa', 'Papuan languages', NULL),
('pag', 'Pangasinan', NULL),
('pal', 'Pahlavi', NULL),
('pam', 'Pampanga; Kapampangan', NULL),
('pan', 'Panjabi; Punjabi', 'pa'),
('pap', 'Papiamento', NULL),
('pau', 'Palauan', NULL),
('peo', 'Persian, Old (ca.600-400 B.C.)', NULL),
('per', 'Persian', 'fa'),
('phi', 'Philippine languages', NULL),
('phn', 'Phoenician', NULL),
('pli', 'Pali', 'pi'),
('pol', 'Polish', 'pl'),
('pon', 'Pohnpeian', NULL),
('por', 'Portuguese', 'pt'),
('pra', 'Prakrit languages', NULL),
('pro', 'Provençal, Old (to 1500)', NULL),
('pus', 'Pushto; Pashto', 'ps'),
('qaa', 'Reserved for local use', NULL),
('que', 'Quechua', 'qu'),
('raj', 'Rajasthani', NULL),
('rap', 'Rapanui', NULL),
('rar', 'Rarotongan; Cook Islands Maori', NULL),
('roa', 'Romance languages', NULL),
('roh', 'Romansh', 'rm'),
('rom', 'Romany', NULL),
('rum', 'Romanian; Moldavian; Moldovan', 'ro'),
('run', 'Rundi', 'rn'),
('rup', 'Aromanian; Arumanian; Macedo-R', NULL),
('rus', 'Russian', 'ru'),
('sad', 'Sandawe', NULL),
('sag', 'Sango', 'sg'),
('sah', 'Yakut', NULL),
('sai', 'South American Indian (Other)', NULL),
('sal', 'Salishan languages', NULL),
('sam', 'Samaritan Aramaic', NULL),
('san', 'Sanskrit', 'sa'),
('sas', 'Sasak', NULL),
('sat', 'Santali', NULL),
('scn', 'Sicilian', NULL),
('sco', 'Scots', NULL),
('sel', 'Selkup', NULL),
('sem', 'Semitic languages', NULL),
('sga', 'Irish, Old (to 900)', NULL),
('sgn', 'Sign Languages', NULL),
('shn', 'Shan', NULL),
('sid', 'Sidamo', NULL),
('sin', 'Sinhala; Sinhalese', 'si'),
('sio', 'Siouan languages', NULL),
('sit', 'Sino-Tibetan languages', NULL),
('sla', 'Slavic languages', NULL),
('slo', 'Slovak', 'sk'),
('slv', 'Slovenian', 'sl'),
('sma', 'Southern Sami', NULL),
('sme', 'Northern Sami', 'se'),
('smi', 'Sami languages', NULL),
('smj', 'Lule Sami', NULL),
('smn', 'Inari Sami', NULL),
('smo', 'Samoan', 'sm'),
('sms', 'Skolt Sami', NULL),
...
('sog', 'Sogdian', NULL),
('som', 'Somali', 'so'),
('son', 'Songhai languages', NULL),
('sot', 'Sotho, Southern', 'st'),
('spa', 'Spanish; Castilian', 'es'),
('srd', 'Sardinian', 'sc'),
('srn', 'Sranan Tongo', NULL),
('srp', 'Serbian', 'sr'),
('srr', 'Serer', NULL),
('ssa', 'Nilo-Saharan languages', NULL),
('ssw', 'Swati', 'ss'),
('suk', 'Sukuma', NULL),
('sun', 'Sundanese', 'su'),
('sus', 'Susu', NULL),
...
('swa', 'Swahili', 'sw'),
('swe', 'Swedish', 'sv'),
('syc', 'Classical Syriac', NULL),
('syr', 'Syriac', NULL),
('tah', 'Tahitian', 'ty'),
('tai', 'Tai languages', NULL),
('tam', 'Tamil', 'ta'),
('tat', 'Tatar', 'tt'),
('tel', 'Telugu', 'te'),
('tem', 'Timne', NULL),
...
('tiv', 'Tiv', NULL),
('tkl', 'Tokelau', NULL),
('tlh', 'Klingon; tlhIngan-Hol', NULL),
('tli', 'Tlingit', NULL),
('tmh', 'Tamashek', NULL),
('tog', 'Tonga (Nyasa)', NULL),
...
('tuk', 'Turkmen', 'tk'),
('tum', 'Tumbuka', NULL),
('tup', 'Tupi languages', NULL),
('tur', 'Turkish', 'tr'),
('tut', 'Altaic languages', NULL),
('tvl', 'Tuvalu', NULL),
('twi', 'Twi', 'tw'),
('tyv', 'Tuvinian', NULL),
('udm', 'Udmurt', NULL),
...
('vol', 'Volapük', 'vo'),
('vot', 'Votic', NULL),
('wak', 'Wakashan languages', NULL),
('wal', 'Walamo', NULL),
('war', 'Waray', NULL),
('was', 'Washo', NULL),
('wel', 'Welsh', 'cy'),
('wen', 'Sorbian languages', NULL),
('wln', 'Walloon', 'wa'),
('wol', 'Wolof', 'wo'),
('xal', 'Kalmyk; Oirat', NULL),
('xho', 'Xhosa', 'xh'),
('yao', 'Yao', NULL),
('yap', 'Yapese', NULL),
('yid', 'Yiddish', 'yi'),
('yor', 'Yoruba', 'yo'),
('ypk', 'Yupik languages', NULL),
('zap', 'Zapotec', NULL),
('zbl', 'Blissymbols; Blissymbolics; Bl', NULL),
('zen', 'Zenaga', NULL),
('zgh', 'Standard Moroccan Tamazight', NULL),
('zha', 'Zhuang; Chuang', 'za'),
('znd', 'Zande languages', NULL),
('zul', 'Zulu', 'zu'),
('zun', 'Zuni', NULL),
('zxx', 'No linguistic content; Not app', NULL),
('zza', 'Zaza; Dimili; Dimli; Kirdki; K', NULL);
...
ALTER TABLE `country_language`
  ...
  ADD CONSTRAINT `country_language_ibfk_2` FOREIGN KEY (`language`) REFERENCES `language` (`code`);
